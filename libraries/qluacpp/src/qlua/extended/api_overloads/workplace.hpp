...
void getDepoEx(const std::string& firmid,
               ...
               std::function<void(const lua::Entity < lua::Type_Adapter<::qlua::table::depo_limits>>&)> lambda) const {
...
void getMoneyEx(const std::string& firmid,
                ...
                const std::string& currcode,
                const int limit_kind,
                std::function<void(const lua::Entity < lua::Type_Adapter<::qlua::table::money_limits>>&)> lambda) const {
...
void getFuturesLimit(const std::string& firmid,
                     ...
                     const std::string& currcode,
                     std::function<void(const lua::Entity < lua::Type_Adapter<::qlua::table::futures_client_limits>>&)> lambda) const {
...
void getPortfolioInfoEx(const std::string& firm_id,
                        const std::string& client_code,
                        const int limit_kind,
                        std::function<void(const lua::Entity < lua::Type_Adapter<::qlua::table::portfolio_info_getPortfolioInfoEx>>&)> lambda) const {
...
void getBuySellInfoEx(const std::string& firm_id,
                      ...
                      const std::string& sec_code,
                      const double price,
                      std::function<void(const lua::Entity < lua::Type_Adapter<::qlua::table::buy_sell_info_getBuySellInfoEx>>&)> lambda) const {
