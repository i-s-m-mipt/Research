...
def predict(asset, scale, data) :
    ...
    try:
        ...
        s += np.argmax(model_01(state_tensor)[0].numpy())
        s += np.argmax(model_05(state_tensor)[0].numpy())
        s += np.argmax(model_09(state_tensor)[0].numpy())
        s += np.argmax(model_11(state_tensor)[0].numpy())
        s += np.argmax(model_14(state_tensor)[0].numpy())
        s += np.argmax(model_15(state_tensor)[0].numpy())
        s += np.argmax(model_19(state_tensor)[0].numpy())
        s += np.argmax(model_20(state_tensor)[0].numpy())
        s += np.argmax(model_21(state_tensor)[0].numpy())
        s += np.argmax(model_24(state_tensor)[0].numpy())
        s += np.argmax(model_26(state_tensor)[0].numpy())
        s += np.argmax(model_30(state_tensor)[0].numpy())
        s += np.argmax(model_32(state_tensor)[0].numpy())
        s += np.argmax(model_33(state_tensor)[0].numpy())
        s += np.argmax(model_36(state_tensor)[0].numpy())
        s += np.argmax(model_37(state_tensor)[0].numpy())
        s += np.argmax(model_40(state_tensor)[0].numpy())
        s += np.argmax(model_41(state_tensor)[0].numpy())
        s += np.argmax(model_42(state_tensor)[0].numpy())
        s += np.argmax(model_43(state_tensor)[0].numpy())
        s += np.argmax(model_44(state_tensor)[0].numpy())
        s += np.argmax(model_49(state_tensor)[0].numpy())
        s += np.argmax(model_50(state_tensor)[0].numpy())
        s += np.argmax(model_53(state_tensor)[0].numpy())
        s += np.argmax(model_54(state_tensor)[0].numpy())
        s += np.argmax(model_60(state_tensor)[0].numpy())
